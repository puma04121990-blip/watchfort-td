...
export type TowerKind = 'arrow' | 'cannon' | 'frost' | 'lightning' | 'sniper' | 'mortar' | 'barracks';
export type EnemyKind = 'runner' | 'tank' | 'brute' | 'swarm' | 'shaman' | 'splitter' | 'armored';
...
export interface EnemyDef {
  ...
  gold: number;
  texture: string;
  /** Flat damage subtracted from each hit (min 1). */
  armorFlat: number;
  /** Cap damage taken per hit; 0 = no cap. Counters sniper burst. */
  hitCap: number;
}
...
export const TOWERS: Record<TowerKind, TowerDef> = {
  ...
  mortar: {
    ...
    slowFactor: 1,
    slowMs: 0,
    projectileKey: 'projectile_mortar',
    projectileSpeed: 280,
    texture: 'tower_mortar',
    soldierHp: 0,
    chainHops: 0,
    chainRange: 0,
  },
...
export const ENEMIES: Record<EnemyKind, EnemyDef> = {
  runner: { kind: 'runner', hp: 36, speed: 68, gold: 10, texture: 'enemy_runner', armorFlat: 0, hitCap: 0 },
  shaman: { kind: 'shaman', hp: 55, speed: 52, gold: 18, texture: 'enemy_shaman', armorFlat: 0, hitCap: 0 },
  tank: { kind: 'tank', hp: 95, speed: 44, gold: 16, texture: 'enemy_tank', armorFlat: 4, hitCap: 0 },
  brute: { kind: 'brute', hp: 190, speed: 36, gold: 28, texture: 'enemy_brute', armorFlat: 6, hitCap: 0 },
  swarm: { kind: 'swarm', hp: 18, speed: 96, gold: 5, texture: 'enemy_swarm', armorFlat: 0, hitCap: 0 },
  splitter: { kind: 'splitter', hp: 52, speed: 50, gold: 14, texture: 'enemy_splitter', armorFlat: 0, hitCap: 0 },
  armored: { kind: 'armored', hp: 120, speed: 38, gold: 22, texture: 'enemy_armored', armorFlat: 8, hitCap: 16 },
};
...
const WAVES_MAP03: WaveSpawn[][] = [
  ...
  [
    ...
    { kind: 'shaman', count: 2, interval: 1600, delay: 900 },
...
const WAVES_MAP04: WaveSpawn[][] = [
  ...
  [
    ...
    { kind: 'armored', count: 2, interval: 1800, delay: 1100 },
  ...
  [
    ...
    { kind: 'armored', count: 3, interval: 1700, delay: 900 },
...
const WAVES_MAP05: WaveSpawn[][] = [
  ...
  [
    ...
    { kind: 'shaman', count: 3, interval: 1400, delay: 700 },
    { kind: 'splitter', count: 3, interval: 1600, delay: 1000 },
    { kind: 'armored', count: 2, interval: 1800, delay: 1000 },
  ...
  [
    ...
    { kind: 'armored', count: 4, interval: 1600, delay: 800 },
...
const WAVES_MAP06: WaveSpawn[][] = [
  ...
  [
    ...
    { kind: 'armored', count: 5, interval: 1500, delay: 700 },
...
/** Spiral pressure: armored packs + dense swarm finale. */
const WAVES_MAP07: WaveSpawn[][] = [
  [
    { kind: 'runner', count: 16, interval: 420, delay: 200 },
    { kind: 'swarm', count: 24, interval: 150, delay: 200 },
    { kind: 'armored', count: 3, interval: 1600, delay: 1200 },
  ],
  [
    { kind: 'runner', count: 14, interval: 380, delay: 150 },
    { kind: 'swarm', count: 28, interval: 140, delay: 150 },
    { kind: 'shaman', count: 4, interval: 1200, delay: 700 },
    { kind: 'splitter', count: 3, interval: 1500, delay: 900 },
    { kind: 'armored', count: 4, interval: 1500, delay: 1000 },
  ],
  [
    { kind: 'tank', count: 8, interval: 900, delay: 300 },
    { kind: 'swarm', count: 30, interval: 130, delay: 100 },
    { kind: 'shaman', count: 5, interval: 1100, delay: 500 },
    { kind: 'splitter', count: 5, interval: 1400, delay: 800 },
    { kind: 'armored', count: 5, interval: 1400, delay: 700 },
    { kind: 'brute', count: 2, interval: 2200, delay: 1800 },
  ],
];
...
export const MAPS: Record<string, MapDef> = {
  ...
  map07: {
    id: 'map07',
    path: PATH_MAP07,
    gate: PATH_MAP07[PATH_MAP07.length - 1] ?? { c: 11, r: 9 },
    waves: WAVES_MAP07,
  },
};

export const MAP_LIST: MapDef[] = [MAPS.map01, MAPS.map02, MAPS.map03, MAPS.map04, MAPS.map05, MAPS.map06, MAPS.map07];
