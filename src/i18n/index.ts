...
const ru: Dict = {
  ...
  'menu.diffHard': 'Сложность: сложная (+HP/скорость, −золото/ворота)',
  ...
  'enemy.swarm': 'рой',
  'enemy.shaman': 'шаман',
  'enemy.splitter': 'носитель',
  'enemy.armored': 'броненосец',
  'tower.arrow': 'Стрелы',
  'tower.cannon': 'Пушка',
  'tower.frost': 'Иней',
...
const en: Dict = {
  ...
  'menu.diffHard': 'Difficulty: hard (+HP/speed, −gold/gate)',
  ...
  'enemy.swarm': 'swarm',
  'enemy.shaman': 'shaman',
  'enemy.splitter': 'carrier',
  'enemy.armored': 'plated',
  'tower.arrow': 'Arrow',
  'tower.cannon': 'Cannon',
  'tower.frost': 'Frost',
